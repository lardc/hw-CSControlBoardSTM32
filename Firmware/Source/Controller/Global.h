...
#define VOLTAGE_ID_ABSOLUTE_MAX_ERR						15		// Абсолютная погрешность определения адаптера (15мВ)
#define VOLTAGE_ID_RELATIVE_MAX_ERR						0.15f	// Отностительная погрешность определения адаптера (15%)
